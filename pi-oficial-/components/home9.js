...
export default class Home9 extends React.Component {
  ponto = Globais.ponto;
  total = Globais.total;

  buttonPontuacao = () => {
    Globais.total = Globais.total + 1;
    this.props.navigation.push('Resultados');
  };
      ...
      <View style={styles.container}>
        ...
        <View style={styles.container2}>
          ...
          <Image
            ...
            source={require('../assets/imgQuiz/balao9.png')}
          />
        </View>
        <TouchableOpacity style={styles.button} onPress={this.buttonNavegacao}>
          <View style={styles.button}>
            <Text style={styles.corText}>
              {' '}
              Aumentar o consumo de papel, de energia elétrica e de plástico.
            </Text>
          </View>
        </TouchableOpacity>
        <TouchableOpacity style={styles.button} onPress={this.buttonNavegacao}>
