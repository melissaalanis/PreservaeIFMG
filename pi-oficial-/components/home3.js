...
export default class Home3 extends React.Component {
  ...
  buttonPontuacao = () => {
    ...
    this.props.navigation.push('Home6');
  };
      ...
      <View style={styles.container}>
        ...
        <TouchableOpacity style={styles.button} onPress={this.buttonPontuacao}>
          <View style={styles.button} onPress={this.calcularIMC}>
            <Text style={styles.corText}>
              {' '}
              Mobilizando pessoas e incentivando projetos de preservação
              ambiental.
            </Text>
          </View>
        </TouchableOpacity>
        <TouchableOpacity style={styles.button} onPress={this.buttonNavegacao}>
          <View style={styles.button}>
            <Text style={styles.corText}>
              Apoiando nas redes sociais projetos que a destroem lentamente.
            </Text>
          </View>
        </TouchableOpacity>
      </View>
