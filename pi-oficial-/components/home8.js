...
export default class Home8 extends React.Component {
  ponto = Globais.ponto;
  total = Globais.total;

  buttonPontuacao = () => {
    Globais.total = Globais.total + 1;
    this.props.navigation.push('Home9');
  };
      ...
      <View style={styles.container}>
        ...
        <View style={styles.container2}>
          ...
          <Image
            ...
            source={require('../assets/imgQuiz/balao8.png')}
          />
        </View>
        <TouchableOpacity style={styles.button} onPress={this.buttonNavegacao}>
          <View style={styles.button}>
            <Text style={styles.corText}>
              Afluente é um grande curso d'água que deságua em um fluxo d'água
              menor.
            </Text>
          </View>
        </TouchableOpacity>
        <TouchableOpacity style={styles.button} onPress={this.buttonNavegacao}>
          <View style={styles.button}>
            <Text style={styles.corText}>
              São agentes ambientais que monitoram determinados cursos d'água.{' '}
            </Text>
          </View>
        </TouchableOpacity>
        <TouchableOpacity style={styles.button} onPress={this.buttonPontuacao}>
          <View style={styles.button} onPress={this.calcularIMC}>
            <Text style={styles.corText}>
              Afluente é um curso d'água cuja vazão contribui para o aumento de
              outro corpo d´água
            </Text>
          </View>
        </TouchableOpacity>
